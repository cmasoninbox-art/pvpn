...
`;
      ...
      // Keep the destination player's signed stream definitions unchanged.
      // Rewriting these URLs invalidates some CDN/player checks and leaves a blank video.
      // The extension and browser handle the native media request directly.
      // CSP: everything flows through our origin      // CSP: everything flows through our origin      // CSP: everything flows through our origin so framed sites can't load the real domain
